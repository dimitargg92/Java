...
public class Pizza {
    ...
    private final String TOPPINGS_OUT_OF_RANGE = "Number of toppings should be in range [0..10].";
    ...
    private void setName (String name){
        ...
        if (name.trim().isEmpty() || name.equals(" ") || name.length() > 15){
    ...
    private void setNumberOfToppings (int numberOfToppings){
        ...
        if (numberOfToppings < 0 || numberOfToppings > 10){
            throw new IllegalArgumentException(TOPPINGS_OUT_OF_RANGE);
    ...
    public String toString (){
        ...
        return String.format("%s - %.2f",this.getName(),getOverallCalories());
    }
}
